...
def GPUTrainingTime(data, labels, features, structure):
	...
	with tf.device("/gpu:0"):
		...
		network = KerasClassifier(build_fn=CreateNeuralNetwork,
			...
			layers=structure,activation=activation,lr=0.1,
...
if __name__ == '__main__':
	...
	features = np.load("data/features/best_features_800i_200g_9c_10m_50f_K_CV_SVM_104")

	structures = [[50],[100],[150],[200],[250],[300],[400],[500],[600],[800],[1000],[1250],[1500]]
