...
\newpage
	...
	\subsection{Population}
		...
		Population size must have an equilibrium between enough individuals to explore the solution space and not too many of them, because fitness evaluation is performed for every individual in every generation.
