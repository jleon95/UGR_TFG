...
\newpage
	...
	\begin{table}[h]
        ...
        \begin{tabular}{| >{\centering\arraybackslash}m{0.7in} | >{\centering\arraybackslash}m{1.1in} | >{\centering\arraybackslash}m{1.1in} |}
            ...
            \hline
            \cellcolor{RoyalBlue}\textbf{110} & $ \pm $ & $0.11794$ \\
            \hline
    ...
    \begin{itemize}
    	...
    	\item
    	Subject 107: $46$ features, $2$ hidden layers ($89$ units, $102$ units), $289$ epochs, $0.022$ learning rate, $0.05$ dropout, ELU activation function.

    	\item
    	Subject 110: $50$ features, $1$ hidden layer ($34$ units), $289$ epochs, $0.040$ learning rate, $0.05$ dropout, ELU activation function.
...
\section{Efficiency study}
	...
	\subsection{Feature selection: Logistic Regression and \acs{SVM}s}
		...
		\begin{table}[h]
	        ...
	        \caption[Average running times: Logistic Regression versus SVM]{Comparison of average running times for Logistic Regression and \acs{SVM}. Run in \hyperlink{server:secondserver}{the second server}.}\label{table:logreg_svm_speed}
