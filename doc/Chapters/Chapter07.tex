...
\newpage
	...
	\begin{figure}[bth]
		...
		\end{center}
		\caption[Evolution comparison with cross-validation and simplicity]{Comparison of mean Kappa loss evolution for both metrics. Note that the vertical axis now has the range $[0,0.5]$, as opposed to the previous $[0,1]$ used in feature selection.}\label{gfx:cv_vs_simplicity}
...
\newpage
    ...
    %The structures that achieved these top results are the input for the second optimization stage.
