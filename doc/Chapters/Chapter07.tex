...
\newpage
    ...
    In this section, we have applied our previous knowledge to obtain neural network structures in a short time. With them as a foundation, \textit{learning optimization}---as we will denote the last step---will be crucial in deciding if the whole process is able to produce competitive enough models.
