...
\newpage
	...
	\begin{table}[h]
        ...
        \begin{tabular}{| >{\centering\arraybackslash}m{0.5in} | >{\centering\arraybackslash}m{1.1in} | >{\centering\arraybackslash}m{1.1in} | >{\centering\arraybackslash}m{1.1in} |}
            ...
            \hline
            \cellcolor{RoyalBlue}\textbf{104} & $0.06534 \pm 0.0074$ & $0.08619 \pm 0.0102$ & $0.07941 \pm 0.0119$ \\
            \hline
            \cellcolor{RoyalBlue}\textbf{107} & $0.15202 \pm 0.0132$ & $0.18004 \pm 0.0137$ & $0.17725 \pm 0.0150$ \\
            \hline
            \cellcolor{RoyalBlue}\textbf{110} & $0.14829 \pm 0.0138$ & $0.17131 \pm 0.0158$ & $0.16569 \pm 0.0187$ \\
            \hline
...
\newpage
    ...
    \begin{figure}[bth]
		...
		\end{center}
		\caption[Kappa loss comparison with Logistic Regression and SVM]{Comparison of Kappa loss evolution over time with Logistic Regression and SVM.}\label{gfx:fs_models_kappa}
