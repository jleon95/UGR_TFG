...
\newpage
	...
	Which, summed up, give a total of $6000$ trainings.
	...
	The proposed simplicity measure is the sum of all the neurons of the given structure (note that the time it takes to compute it is negligible). This way, we can factor out $5000$ of the $6000$ evaluations; in a more general statement, we are reducing the computational load in five sixths---or approximately $83\%$.
