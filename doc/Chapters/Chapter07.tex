...
\newpage
	...
	Finally, although by now it should go without saying that feature selection is essential in our problem, Table \ref{table:feature_selection_comparison} puts our best results against classifiers using all 3600 features.
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{| >{\centering\arraybackslash}m{0.7in} | >{\centering\arraybackslash}m{0.7in} | >{\centering\arraybackslash}m{0.7in} | >{\centering\arraybackslash}m{0.7in} | >{\centering\arraybackslash}m{0.7in} |}
            ...
            \hline
            \cellcolor{RoyalBlue}\textbf{104} & $0.042246$ & $0.067654$ & $0.279954$ & $0.305215$ \\
            \hline
            \cellcolor{RoyalBlue}\textbf{107} & $0.101059$ & $0.134644$ & $0.327885$ & $0.328009$ \\
            \hline
            \cellcolor{RoyalBlue}\textbf{110} & $0.117981$ & $0.143276$ & $0.404468$ & $0.404545$ \\
            \hline
