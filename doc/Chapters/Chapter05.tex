...
\newpage
	...
	Some parameters are up to the designer, such as how many offspring are returned, the crossover and mutation probabilities, or the operators. For the latter, some common alternatives are found in the algorithms \ref{alg:singlepointx}, \ref{alg:twopointx}, \ref{alg:uniformx} and \ref{alg:flipbitsm}.