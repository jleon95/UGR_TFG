...
\newpage
	...
	\begin{algorithm}[H]
		...
		\caption{Population evaluation}\label{alg:evaluation}
...
\newpage
	...
	\begin{algorithm}[H]
		...
		\caption{Non-dominated sort steps}\label{alg:nds}
...
\newpage
	...
	\begin{algorithm}[H]
		...
		\caption{Front computation}\label{alg:fronts}
	...
	\begin{algorithm}[H]
		...
		\caption{Selection operator}\label{alg:selection}
	...
	\begin{algorithm}[H]
		...
		\caption{Offspring creation}\label{alg:offspring_fs}
...
\newpage
	...
	\begin{algorithm}[H]
		...
		\caption{Population replacement}\label{alg:replacement}
	...
	There is, nevertheless, a topic we have not covered with all the pseudocode of this chapter: the fitness or objective functions. In accordance with the design of the algorithm, they are based on minimization rather than maximization. They are the following:
